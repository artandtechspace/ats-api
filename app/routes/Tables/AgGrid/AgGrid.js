...
import {Card, CardFooter, CardHeader, Container, Input, InputGroup,} from './../../../components';
    ...
    render() {
        ...
        return (
            <Container>
                ...
                />
                <p className="pb-3">
                    <strong>Over 2,500 Companies use ag-Grid.</strong> The &quot;ag&quot; part of ag-Grid stands
                    for &quot;agnostic&quot;. The internal ag-Grid engine is implemented in TypeScript with zero
                    dependencies. ag-Grid supports Angular through a wrapper component.
                    The wrapper lets you use ag-Grid in your application like any other Angular component – you pass
                    configuration through property bindings and handle events through event bindings.
                ...
                <Card>
                    ...
                    <CardFooter className="bg-white text-center">
                        More examples of this table can be found <a href="https://www.ag-grid.com" target="_blank"
