...
import {Card, CardBody, CardTitle, Col, Container, Row, Table,} from './../../../components';
            ...
            <Row>
                <Col lg={12}>
                    <HeaderDemo
                        ...
                        subTitle={(
                            <React.Fragment>
                                All table styles are inherited in Bootstrap 4, meaning any nested tables will be styled
                ...
                <Col lg={12}>
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="mb-0">
                                Using the most basic table markup, here’s how <code>.table-based</code> tables look in
                                Bootstrap.
                                All table styles are inherited in Bootstrap 4, meaning any nested tables will be styled
                                in the
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="mb-0">
                                ...
                                Make any table responsive across all viewports by wrapping
