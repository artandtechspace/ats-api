                ...
                <Col lg={6}>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                <CardTitle tag="h6">
                                    <CustomInput type="checkbox" className="ml-auto" id="leftCheckbox"
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                ...
                                <div className="ml-auto d-flex">
                                    <CustomInput type="radio" className="mr-3" name="rightRadioInline"
                                                 id="rightRadioYes" label="Yes"/>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <Form inline className="ml-auto">
                                    <FormGroup>
                                        <Input type="text" bsSize="sm" name="text" id="text" className="ml-auto"
                                               placeholder="Search..."/>
                                    </FormGroup>
                                </Form>
                            </div>
                                ...
                                <Form inline className="ml-auto">
                                    <FormGroup>
                                        <InputGroup size="sm">
                                            ...
                                            <Input type="text" name="text" id="text" className="ml-auto"
