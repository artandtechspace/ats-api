...
const SimpleLineChart = () => (
    <ResponsiveContainer width='100%' aspect={6.0 / 3.0}>
        <LineChart data={data}
            ...
            <Tooltip/>
            <Legend/>
            <Line dataKey="pv" stroke={colors['success']} dot={generateDot} activeDot={generateActiveDot}
                  name='Internistic Value'/>
            <Line dataKey="uv" stroke={colors['purple']} dot={generateDot} activeDot={generateActiveDot}
                  name='Buy Price'/>
            <Line dataKey="amt" stroke={colors['blue']} dot={generateDot} activeDot={generateActiveDot}
                  name='Stock Price'/>
        </LineChart>
    </ResponsiveContainer>
);
