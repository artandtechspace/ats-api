            ...
            <Row>
                ...
                <Col lg={6}>
                    ...
                    <div className="mb-5">
                        ...
                        <p>
                            From the color palette, add to <code>&lt;ListGroupItem&gt;</code> for
                            example: <code>success</code>, <code>primary</code> etc.
                        </p>
                        <ListGroup>
                        ...
                        <ListGroup>
                            <ListGroupItem>
                                <Media>
                                    ...
                                    <Media right top>
                                        <div>
                                            <CustomInput type="radio" id="rightRadio1" name="customRadio" label=""
                                                         defaultChecked/>
                                        </div>
                                    </Media>
                                </Media>
                            ...
                            <ListGroupItem>
                                <Media>
                                    <Media left className="mr-3">
                                        <CustomInput type="radio" id="leftRadio1" name="leftRadio" label=""
                                                     defaultChecked/>
                                    </Media>
                                    <Media body>
                                        <span className="mt-0 d-flex h6 mb-1">
                    ...
                    <div className="mb-5">
                        ...
                        <ListGroup>
                            ...
                            <ListGroupItem>
                                <Media>
                                    <Media left top className="mr-3">
                                        <CustomInput className="pt-0 mt-0" type="checkbox" id="leftCheckbox2"
                                                     name="leftRadio" label=""/>
                                    </Media>
                                    <Media body>
                                        <span className="mt-0 d-flex h6 mb-1">
                                            {faker.name.firstName()} {faker.name.lastName()}
                            ...
                            <ListGroupItem>
                                <Media>
                                    <Media left top className="mr-3">
                                        <CustomInput className="pt-0 mt-0" type="checkbox" id="leftCheckbox3"
                                                     name="leftRadio" label=""/>
                                    </Media>
                                    <Media body>
                                        <span className="mt-0 d-flex h6 mb-1">
