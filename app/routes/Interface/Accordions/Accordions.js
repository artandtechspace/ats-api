...
import {Accordion, CardText, Col, Container, Row,} from './../../../components';
            ...
            <Row>
                ...
                <Col lg={6}>
                    ...
                    <div className="mb-5">
                        ...
                        <p>
                            Below is an example of default accordion based
                            on <code>Card</code>, <code>h6</code>, <code>&lt;i className="fa fa-fw fa-plus" /&gt;</code>
                            and <code>UncontrolledCollapse</code>.
                        </p>
                        <Accordion className="mb-2" initialOpen>
                            <Accordion.Header className='h6'>
