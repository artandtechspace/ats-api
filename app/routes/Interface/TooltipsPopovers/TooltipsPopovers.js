            ...
            <Row>
                <Col lg={12}>
                    <Card className="mb-3">
                        <CardBody>
                            <CardText>
                                Tight pants next level keffiyeh <a href="#" id="UncontrolledTooltip1">you
                                probably</a> haven't heard of them.
                                ...
                                apparel <a href="#" id="UncontrolledTooltip2">have a</a> terry richardson vinyl
                                chambray. Beard stumptown, cardigans
                                ...
                                mcsweeney's cleanse vegan chambray. A really ironic artisan <a href="#"
                                                                                               id="UncontrolledTooltip3">whatever
                                keytar</a>,
                                scenester farm-to-table banksy Austin <a href="#" id="UncontrolledTooltip4">twitter
            ...
            <Row>
                <Col lg={12}>
                    <HeaderDemo
                        ...
                        subTitle={(
                            <React.Fragment>
                                Four options are available: <code>top</code>, <code>right</code>, <code>bottom</code>,
                                and <code>left</code> aligned.
                            </React.Fragment>
                        )}
                    />
                </Col>
