                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <Checkable tag={Media}>
                                ...
                                <Media right top>
                                    <Checkable.Input tag={CustomInput} type="checkbox" id="rightCheckbox1"
                                                     defaultChecked/>
                                </Media>
                            </Checkable>
                            <Checkable tag={Media}>
                        ...
                        <CardBody>
                            ...
                            <Checkable tag={Media}>
                                ...
                                <Checkable.Trigger tag={Media} right top>
                                    <Checkable.Input tag={CustomInput} type="radio" id="rightRadio1" name="customRadio"
                                                     defaultChecked/>
                                </Checkable.Trigger>
                            </Checkable>
                            <Checkable tag={Media}>
                                ...
                                <Media right top>
                                    <Checkable.Input tag={CustomInput} type="radio" id="rightRadio2"
                                                     name="customRadio"/>
                                </Media>
                            </Checkable>
                            <Checkable tag={Media}>
                                ...
                                <Media right top>
                                    <Checkable.Input tag={CustomInput} type="radio" id="rightRadio3"
                                                     name="customRadio"/>
                                </Media>
                            </Checkable>
                        </CardBody>
