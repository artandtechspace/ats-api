...
import {Card, CardBody, CardTitle, Col, Container, Progress, Row,} from './../../../components';
                ...
                <Col lg={4}>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Color progress styling. Use
                                <code> &lt;Progress value={'{'}50{'}'} style={'{'}{'{'}height:
                                    "5px"{'}'}{'}'}/&gt;</code>
                            </p>
                ...
                <Col lg={4}>
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Color progress styling. Use
                                <code> &lt;Progress value={'{'}60{'}'} style={'{'}{'{'}height:
                                    "3px"{'}'}{'}'}/&gt;</code>
                            </p>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Color progress styling. Use
                                <code> &lt;Progress value={'{'}30{'}'} style={'{'}{'{'}height:
                                    "1px"{'}'}{'}'}/&gt;</code>
                            </p>
                ...
                <Col lg={4}>
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Color progress styling. Use
                                <code> &lt;Progress value={'{'}70{'}'} style={'{'}{'{'}height:
                                    "4px"{'}'}{'}'}/&gt;</code>
                            </p>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Color progress styling. Use
                                <code> &lt;Progress value={'{'}40{'}'} style={'{'}{'{'}height:
                                    "2px"{'}'}{'}'}/&gt;</code>
                            </p>
                ...
                <Col lg={4}>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Custom progress styling. Use
                                <code> &lt;Progress value={'{'}25{'}'}&gt;&lt;i className="fa
                                    fa-twitter"&gt;&lt;/i&gt;&lt;Progress&gt;</code>
                            </p>
                ...
                <Col lg={4}>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            ...
                            <p className="card-text">
                                Custom progress styling. Use <code>&lt;Progress animated striped
                                value={'{'}45{'}'} /&gt;</code>
                            </p>
