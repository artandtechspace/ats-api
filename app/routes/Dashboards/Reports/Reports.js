        ...
        <Row className="mb-2">
            ...
            <Col xl={3} lg={6} className="mb-4 mb-lg-0">
                <Card>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesProcessorToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Processor
                            <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                               id="TemperaturesProcessorTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesGraphicsToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Graphics
                            <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                               id="TemperaturesGraphicsTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesStorageToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Storage
                            <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                               id="TemperaturesStorageTooltip"></i>
                        </ListGroupItem>
            ...
            <Col xl={3} lg={6} className="mb-4 mb-lg-0">
                <Card className="mb-sm-4 mb-xl-0">
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="ProcessorToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Processor
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="UsageLoadToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="GraphicsToggler"
                                       className="by-0 d-flex text-decoration-none">
                            Graphics
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="UsageLoadToggler2"
                                       className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                            <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                               id="UsageLoadTooltip2"></i>
                        </ListGroupItem>
                ...
                <Row>
                    <Col xl={6} lg={6}>
                        <Card className="mb-4">
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="#" id="RamToggler"
                                               className="by-0 d-flex text-decoration-none">
                                    RAM
                                    <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                                       id="RamTooltip"></i>
                    ...
                    <Col xl={6} lg={6}>
                        <Card className="mb-4">
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="#" id="FansToggler"
                                               className="by-0 d-flex text-decoration-none">
                                    Fans
                                    <i className="fa fa-fw fa-angle-down ml-auto justify-content-end"
                                       id="FansTooltip"></i>
                            ...
                            <UncontrolledCollapse toggler="#FansToggler" isOpen>
                                <CardBody className="pt-0">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="range" max="3" step="1" className="custom-range pb-0"
                                               id="leftFontalFan"/>
                                        <span className="d-flex">
                                            <span>
                                                <i className="fa fa-fw fa-leaf"></i>
                        ...
                        <Card>
                            <CardBody className="bb-0 pb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="ml-auto justify-content-start">
                                        <a href="javascript:;" className="ml-auto justify-content-start pr-2"
