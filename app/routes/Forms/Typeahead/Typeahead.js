...
import {Card, CardBody, CardTitle, Col, Container, Row} from './../../../components';
import {
    AsyncPagination,
    AsyncSearch,
    BasicBehaviors,
        ...
        <HeaderDemo
            ...
            subTitle={(
                <React.Fragment>
                    ...
                    You can position the menu above the input with <code>dropup</code> or aoutomatically re-position it
                    when it hits the viewport bounds.
                ...
                <Card>
                    <CardBody>
                        ...
                        <p>
                            ...
                            Setting the <code>clearButton</code> prop displays a button allowing users to clear the
                            input.
                        </p>
                        <ControllingSelections/>
                    </CardBody>
            ...
            <Col>
                ...
                <Card>
                    <CardBody className="pb-0">
                        ...
                        <p>
                            The typeahead works with Bootstrap input groups and add-ons; it also handles validation
                            states.
                        </p>
                        <FormExample/>
                    </CardBody>
