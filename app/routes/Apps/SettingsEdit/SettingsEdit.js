                        ...
                        <CardBody>
                            ...
                            <Form>
                                ...
                                <FormGroup className="mb-5">
                                    ...
                                    <CustomInput type="radio" id="privateMessageYes" name="privateMessage" label="Yes"
                                                 defaultChecked/>
                                ...
                                <FormGroup className="mb-5">
                                    ...
                                    <CustomInput type="radio" id="someoneComments" name="ActivityNotifications"
                                                 label="Someone Comments" defaultChecked/>
                                    <CustomInput type="radio" id="someoneMentions" name="ActivityNotifications"
                                                 label="Someone Mentions"/>
                                    <CustomInput type="radio" id="anyoneFollowsMe" name="ActivityNotifications"
