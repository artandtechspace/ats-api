...
export function SidebarMiddleNav() {
    const {t} = useTranslation();
    return (
        <SidebarMenu>
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-home"></i>} title={t('SidebarMiddleNav.dashboard')}>
                <SidebarMenu.Item title={t('SidebarMiddleNav.overview')} to='/dashboards/analytics' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.maker')} to='/dashboards/projects' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.projektlabor')} to='/dashboards/system' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.projects')} to='/dashboards/stock' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.delivery')} to='/dashboards/reports' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.inventory')} to='/dashboards/monitor' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.finances')} to='/dashboards/financial' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.events')} to='/dashboards/stock' exact/>
                <SidebarMenu.Item title={t('SidebarMiddleNav.server')} to='/dashboards/reports' exact/>
            </SidebarMenu.Item>
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-th"></i>} title="Widgets" to='/widgets'/>
            { /* -------- Cards ---------*/}
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-clone"></i>} title="Cards">
            ...
            { /* -------- Interface ---------*/}
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-toggle-on"></i>} title="Interface">
            ...
            { /* -------- Forms ---------*/}
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-check-square-o"></i>} title="Forms">
            ...
            { /* -------- Tables ---------*/}
            <SidebarMenu.Item icon={<i className="fa fa-fw fa-trello"></i>} title="Tables">
